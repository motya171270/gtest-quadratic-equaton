...
TEST(TestStdOut, TestStdOut) {
    ...
    // запускаем функцию
    printQuadraticEquationSolution(-3.0, 3.0, -3.0);
    printQuadraticEquationSolution(3.0, 6.0, 3.0);
    printQuadraticEquationSolution(1.0, 4.0, 3.0);
    printQuadraticEquationSolution(0.0, 0.0, 0.0);
    printQuadraticEquationSolution(0.0, 0.0, 3.0);
    printQuadraticEquationSolution(0.0, 2.0, 3.0);
